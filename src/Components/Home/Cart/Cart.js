                                                    ...
                                                    <tr>
                                                        <td className="product-thumbnail">
                                                            <a href="/">
                                                                {
                                                                    products.image.img ?
                                                                        <img src={`data:image/png;base64,${products.image.img}`} alt="" width="500" height="400" /> :
                                                                        <img src={`data:image/png;base64,${products.image}`} alt="" width="500" height="400" />
                                                                }
                                                            </a>
                                                        </td>
                                                        ...
                                                        <td className="product-subtotal">
                                                            ...
                                                            <span className="remove" onClick={() => onItemRemove(products)} >
                                        ...
                                        <Col lg={6} className="offset-lg-3">
                                            <div className="cart-totals">
                                                ...
                                                <div className="text-center">
                                                    <Link to="/checkout" className="default-btn page-btn">Checkout</Link>
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
